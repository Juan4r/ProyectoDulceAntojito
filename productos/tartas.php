...
<div class="container py-5">
  <h2 class="mb-5 fw-bold">TARTAS</h2>

  <!-- Producto 1 -->
  <div class="producto">
    <img src="../interfaz/img/Tarta de Frutas Frescas.jpg" alt=" Tarta de Frutas Frescas">
    <div class="producto-info">
      <h5> Tarta de Frutas Frescas</h5>
      <p>Base de masa sablé crocante, rellena con crema pastelera suave y cubierta con una colorida mezcla de frutas frescas (fresas, kiwi, uvas, mango). Un postre visualmente impactante y lleno de sabor natural.</p>
  ...
  <div class="producto reverso">
    <img src="../interfaz/img/Tarta de Ganache de Chocolate.jpg" alt="Tarta de Ganache de Chocolate">
    <div class="producto-info">
      <h5>Tarta de Ganache de Chocolate</h5>
      <p>Una base de tarta fina rellena con ganache de chocolate amargo 70%, decorada con virutas, almendras tostadas o frambuesas. Textura firme y sabor intenso, ideal para los amantes del cacao.</p>
  ...
  <!-- Producto 3 -->
  <div class="producto">
    <img src="../interfaz/img/ta" alt=" Tarta de Limón con Merengue">
    <div class="producto-info">
      <h5> Tarta de Limón con Merengue</h5>
      <p>Una base crujiente rellena con crema de limón (lemon curd) y cubierta con un merengue italiano perfectamente flameado. El contraste entre ácido, dulce y crujiente la convierte en una obra maestra pastelera.</p>
